      ...
      if (meta && meta.openings && meta.openings.length > 0) {
        ...
        meta.openings.forEach((op) => {
          ...
          if (op.isDoor) {
            ...
            deductValSqFt = openingDefaults.windowDeductArea;
          } else {
            deductValSqFt = openingDefaults.missingWallDeductArea;
          }
